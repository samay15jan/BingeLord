...
const CenterLogo = styled.img`${tw`hidden lg:inline xl:inline 2xl:inline w-48 lg:w-48 xl:w-48 2xl:w-72 mx-48 mt-4`}`
const CenterLogoMobile = styled.img`${tw`lg:hidden xl:hidden 2xl:hidden absolute left-3 top-[3rem] w-44`}`
