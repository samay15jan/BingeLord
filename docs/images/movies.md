...
Retrieves specific images for a given movie.

+++ Request
  HTTP
  ```http
    GET /api/imagesMovie?id={movie_id}
  ```
  cURL
  ```sh
    curl -X GET "https://bingelord-backend.onrender.com/api/imagesMovie?id=12345"
  ```
+++ Response
  ```json
{
...
|-----------|---------------------------|---------|----------|
| [!badge variant="dark" text="id"] | Movie ID to fetch images. | None | [!badge variant="dark" text="true"] |
