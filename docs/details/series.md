...
Retrieves detailed information about a specific TV series, including videos, credits, and similar series.

+++ Request
  HTTP
  ```http
    GET /api/series?id={series_id}
  ```
  cURL
  ```sh
    curl -X GET "https://bingelord-backend.onrender.com/api/series?id=12345"
  ```
+++ Response
  ```json
{
...
|-----------|---------------------------|---------|----------|
| [!badge variant="dark" text="id"] | Series ID to fetch details. | None | [!badge variant="dark" text="true"] |

---

### Season Information

Retrieves details of a specific season of a TV series.

+++ Request
  HTTP
  ```http
    GET /api/season?id={series_id}&season={season_number}
  ```
  cURL
  ```sh
    curl -X GET "https://bingelord-backend.onrender.com/api/season?id=12345&season=1"
  ```
+++ Response
  ```json
  {
    ...
    },
    {
      ...
      "guest_stars": [
        ...
        },
        {
          ...
          "popularity": 8.385,
          "profile_path": "/oaRjlx2l3yVSFVHzGSPq68fZXcD.jpg"
        },
        {
...
| Parameter | Description               | Default | Required |
|-----------|---------------------------|---------|----------|
| [!badge variant="dark" text="id"] | Series ID to fetch season details. | None | [!badge variant="dark" text="true"] |
| [!badge variant="dark" text="season"] | Season number to fetch details. | None | [!badge variant="dark" text="true"] |
